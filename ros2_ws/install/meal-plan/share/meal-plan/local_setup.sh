...
: ${AMENT_CURRENT_PREFIX:="/u/nuzhat/Documents/Robot-Dining-Hall-Personalized-Plan/ros2_ws/install/meal-plan"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/meal-plan/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/meal-plan/environment/path.sh"
